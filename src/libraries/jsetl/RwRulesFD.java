...
/**
 * Rewrite rules for constraints over finite domains (and labeling of all supported variable types in {@code libraries.z.jsetl}).
...
class RwRulesFD extends LibConstraintsRules {
     ...
     */
    protected  
    RwRulesFD(@NotNull Solver solver) {
        super(solver);
    }
    ...
    /**
     * Solves an atomic constraint of the type {@code x = y + libraries.z}.
     * In which {@code x, y, libraries.z} are respectively the first, second
    ...
    /**
     * Solves an atomic constraint of the type {@code x = y mod libraries.z}.
     * In which {@code x, y, libraries.z} are respectively the first, second
     * and third argument of the atomic constraint.
     * @param aConstraint atomic constraint.
     * @throws Fail  if inconsistencies are found.
