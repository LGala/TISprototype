...
import libraries.jsetl.annotation.Nullable;
import libraries.jsetl.exception.InitLObjectException;
...
public class LSet extends LCollection 
        ...
        if (this.equ == null) {
            if (!this.initialized) normalizedSet = this;
                ...
                for(int i = 0; i < thisElements.size(); ++i){
                    ...
                    if(thisElements.subList(0, i).stream().noneMatch(otherElement -> equals(otherElement, element)))
        ...
        if (this.equ == null && (lSet).getEqu() == null) {
            if (this == lSet) return true;
                ...
                for (Object thisLSetElement: thisLSetElements)
                    if(otherLSetElements.stream().noneMatch(otherLSetElement -> equals(otherLSetElement, thisLSetElement)))
                        return false;
                for(Object otherLSetElement : otherLSetElements)
                    if(thisLSetElements.stream().noneMatch(thisLSetElement -> equals(thisLSetElement, otherLSetElement)))
                        return false;
     ...
     */
    public @NotNull Constraint eq(@NotNull LSet lSet){
        Objects.requireNonNull(lSet);

        return new Constraint("_eq", this, lSet);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint eq(@NotNull Set<?> set){
        Objects.requireNonNull(set);
        if(set.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint("_eq", this, set);
    }
     ...
     * @return the constructed constraint.
     */
    public @NotNull Constraint neq(@NotNull LSet lSet){
        Objects.requireNonNull(lSet);

        return new Constraint("_neq", this, lSet);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint neq(@NotNull Set<?> set){
        Objects.requireNonNull(set);
        if(set.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint("_neq", this, set);
    }
     ...
     */
    public @NotNull Constraint contains(@NotNull Object object) {
        Objects.requireNonNull(object);

        return new Constraint(Environment.inCode, object, this);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint ncontains(@NotNull Object object) {
        Objects.requireNonNull(object);

        return new Constraint(Environment.ninCode, object, this);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint diff(@NotNull LSet lSet1, @NotNull LSet lSet2) {
        Objects.requireNonNull(lSet1);
        Objects.requireNonNull(lSet2);

        return new Constraint(Environment.diffCode, this, lSet1, lSet2);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint diff(@NotNull LSet lSet, @NotNull Set<?> set) {
        Objects.requireNonNull(lSet);
        Objects.requireNonNull(set);
        if(set.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint(Environment.diffCode, this, lSet, set);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint diff(@NotNull Set<?> set, @NotNull LSet lSet) {
        Objects.requireNonNull(lSet);
        Objects.requireNonNull(set);
        if(set.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint(Environment.diffCode, this, set, lSet);
    }
     ...
     */
    public @NotNull Constraint diff(@NotNull Set<?> set1, @NotNull Set<?> set2) {
        ...
        return new Constraint(Environment.diffCode, this, set1, set2);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint disj(@NotNull LSet lSet) {
        Objects.requireNonNull(lSet);

        return new Constraint(Environment.disjCode, this, lSet);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint disj(@NotNull Set<?> set) {
        Objects.requireNonNull(set);

        if(set.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint(Environment.disjCode, this, set);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint inters(@NotNull LSet lSet1, @NotNull LSet lSet2) {
        Objects.requireNonNull(lSet1);
        Objects.requireNonNull(lSet2);

        return new Constraint(Environment.intersCode, this, lSet1, lSet2);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint inters(@NotNull LSet lSet, @NotNull Set<?> set) {
        Objects.requireNonNull(lSet);
        Objects.requireNonNull(set);
        ...
        return new Constraint(Environment.intersCode, this, lSet, set);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint inters(@NotNull Set<?> set, @NotNull LSet lSet) {
        Objects.requireNonNull(set);
        Objects.requireNonNull(lSet);
        ...
        return new Constraint(Environment.intersCode, this, set, lSet);
    }
     ...
     * @throws NullPointerException if {@code set1} or {@code set2} contain {@code null} values.
     */
    public @NotNull Constraint inters(@NotNull Set<?> set1, @NotNull Set<?> set2) {
        Objects.requireNonNull(set1);
        Objects.requireNonNull(set2);
        ...
        return new Constraint(Environment.intersCode, this, set1, set2);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint less(@NotNull LVar lVar, @NotNull LSet lSet) {
        Objects.requireNonNull(lSet);
        Objects.requireNonNull(lVar);

        return new Constraint(Environment.lessCode, this, lVar, lSet);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint less(@NotNull Object object, @NotNull LSet lSet) {
        Objects.requireNonNull(lSet);
        Objects.requireNonNull(object);

        return new Constraint(Environment.lessCode, this, object, lSet);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint less(@NotNull LVar lVar, @NotNull Set<?> set) {
        Objects.requireNonNull(set);
        Objects.requireNonNull(lVar);
        ...
        return new Constraint(Environment.lessCode, this, lVar, set);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint less(@NotNull Object object, @NotNull Set<?> set) {
        Objects.requireNonNull(set);
        Objects.requireNonNull(object);
        ...
        return new Constraint(Environment.lessCode, this, object, set);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint size(@NotNull IntLVar size) {
        Objects.requireNonNull(size);

        return new Constraint(Environment.sizeCode, this, size);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint size(@NotNull Integer size) {
        Objects.requireNonNull(size);
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint subset(@NotNull LSet lSet) {
        Objects.requireNonNull(lSet);

        return new Constraint(Environment.subsetCode, this, lSet);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint subset(@NotNull Set<?> set) {
        Objects.requireNonNull(set);

        if(set.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint(Environment.subsetCode, this, set);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint union(@NotNull LSet lSet1, @NotNull LSet lSet2) {
        Objects.requireNonNull(lSet1);
        Objects.requireNonNull(lSet2);

        return new Constraint(Environment.unionCode, this, lSet1, lSet2);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint union(@NotNull LSet lSet, @NotNull Set<?> set) {
        Objects.requireNonNull(lSet);
        Objects.requireNonNull(set);
        ...
        return new Constraint(Environment.unionCode, this, lSet, set);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint union(@NotNull Set<?> set, @NotNull LSet lSet) {
        Objects.requireNonNull(set);
        Objects.requireNonNull(lSet);
        ...
        return new Constraint(Environment.unionCode, this, set, lSet);
    }
     ...
     * @throws NullPointerException if {@code set1} or {@code set2} contain {@code null} values.
     */
    public @NotNull Constraint union(@NotNull Set<?> set1, @NotNull Set<?> set2) {
        Objects.requireNonNull(set1);
        Objects.requireNonNull(set2);
        ...
        return new Constraint(Environment.unionCode, this, set1, set2);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint nunion(@NotNull LSet lSet1, @NotNull LSet lSet2) {
        Objects.requireNonNull(lSet1);
        Objects.requireNonNull(lSet2);

        return new Constraint(Environment.nunionCode, this, lSet1, lSet2);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint nunion(@NotNull LSet lSet, @NotNull Set<?> set) {
        Objects.requireNonNull(lSet);
        Objects.requireNonNull(set);
        ...
        return new Constraint(Environment.nunionCode, this, lSet, set);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint nunion(@NotNull Set<?> set, LSet lSet) {
        Objects.requireNonNull(set);
        Objects.requireNonNull(lSet);
        ...
        return new Constraint(Environment.nunionCode, this, set, lSet);
    }
     ...
     * @throws NullPointerException if {@code set1} or {@code set2} contain {@code null} values.
     */
    public @NotNull Constraint nunion(@NotNull Set<?> set1, @NotNull Set<?> set2) {
        Objects.requireNonNull(set1);
        Objects.requireNonNull(set2);
        ...
        return new Constraint(Environment.nunionCode, this, set1, set2);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint ndisj(@NotNull LSet lSet) {
        Objects.requireNonNull(lSet);

        return new Constraint(Environment.ndisjCode, this, lSet);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint ndisj(@NotNull Set<?> set) {
        Objects.requireNonNull(set);

        if(set.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint(Environment.ndisjCode, this, set);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint nsubset(@NotNull LSet lSet) {
        Objects.requireNonNull(lSet);

        return new Constraint(Environment.nsubsetCode, this, lSet);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint nsubset(@NotNull Set<?> set) {
        Objects.requireNonNull(set);

        if(set.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint(Environment.nsubsetCode, this, set);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint ninters(@NotNull LSet lSet1, @NotNull LSet lSet2) {
        Objects.requireNonNull(lSet1);
        Objects.requireNonNull(lSet2);

        return new Constraint(Environment.nintersCode, this, lSet1, lSet2);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint ninters(@NotNull LSet lSet, @NotNull Set<?> set) {
        Objects.requireNonNull(lSet);
        Objects.requireNonNull(set);
        ...
        return new Constraint(Environment.nintersCode, this, lSet, set);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint ninters(@NotNull Set<?> set, @NotNull LSet lSet) {
        Objects.requireNonNull(set);
        Objects.requireNonNull(lSet);
        ...
        return new Constraint(Environment.nintersCode, this, set, lSet);
    }
     ...
     * @throws NullPointerException if {@code set1} or {@code set2} contain {@code null} values.
     */
    public @NotNull Constraint ninters(@NotNull Set<?> set1, @NotNull Set<?> set2) {
        Objects.requireNonNull(set1);
        Objects.requireNonNull(set2);
        ...
        return new Constraint(Environment.nintersCode, this, set1, set2);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint ndiff(@NotNull LSet lSet1, @NotNull LSet lSet2) {
        Objects.requireNonNull(lSet1);
        Objects.requireNonNull(lSet2);

        return new Constraint(Environment.ndiffCode, this, lSet1, lSet2);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint ndiff(@NotNull LSet lSet, @NotNull Set<?> set) {
        Objects.requireNonNull(lSet);
        Objects.requireNonNull(set);
        ...
        return new Constraint(Environment.ndiffCode, this, lSet, set);
    }
     ...
     * @throws NullPointerException if {@code set} contains {@code null} values.
     */
    public @NotNull Constraint ndiff(@NotNull Set<?> set, @NotNull LSet lSet) {
        Objects.requireNonNull(set);
        Objects.requireNonNull(lSet);
        ...
        return new Constraint(Environment.ndiffCode, this, set, lSet);
    }
     ...
     * @throws NullPointerException if {@code set1} or {@code set2} contain {@code null} values.
     */
    public @NotNull Constraint ndiff(@NotNull Set<?> set1, @NotNull Set<?> set2) {
        Objects.requireNonNull(set1);
        Objects.requireNonNull(set2);
        ...
        return new Constraint(Environment.ndiffCode, this, set1, set2);
    }
