...
public class IntLSet extends LSet
    ...
    public @NotNull String toString(){
        ...
        this.forEach(element -> {
            ...
            else if(element instanceof LVar && isGround(element))
     ...
     */
    public @NotNull Constraint domAll(int glb, int lub){
     ...
     * @return the constructed constraint.
     */
    public @NotNull Constraint labelAll() {
        Constraint result = labelAll(new LabelingOptions());
        assert result != null;
        return result;
    }
     ...
     * @return the constructed constraint.
     */
    public @NotNull Constraint labelAll(@NotNull LabelingOptions labelingOptions) {
