...
public abstract class LObject {
    ...
    protected static @NotNull ArrayList<LObject> getNotInitializedLObjectsArrayList(){
        ...
        Solver currentExecutingSolver = null;
        if(record != null){
     ...
     */
    protected static void setCurrentExecutingSolver(@Nullable Solver solver){
        Thread thread = Thread.currentThread();
        NotInitializedLObjectsRecord record = notInitializedLObjectsMap.get(thread);
     ...
     */
    public @NotNull Constraint in(@NotNull LSet lSet) {
        Objects.requireNonNull(lSet);
        return new Constraint(Environment.inCode, this, lSet);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint in(@NotNull Set<?> set) {
        Objects.requireNonNull(set);
        return new Constraint(Environment.inCode, this, set);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint nin(@NotNull LSet lSet) {
        Objects.requireNonNull(lSet);
        return new Constraint(Environment.ninCode, this, lSet);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    public @NotNull Constraint nin(@NotNull Set<?> set) {
        Objects.requireNonNull(set);
        return new Constraint(Environment.ninCode, this, set);
    }
    ...
    protected static class NotInitializedLObjectsRecord {
         ...
         */
        NotInitializedLObjectsRecord(@Nullable Solver currentExecutingSolver, @NotNull ArrayList<LObject> notInitializedLObjectsList) {
