...
public class LPair extends LList 
    ...
    public LPair(@NotNull String name, @NotNull Object first, @NotNull Object second) {
        super(name, new ArrayList<>(Arrays.asList(first, second)), empty());
     ...
     * @throws InitLObjectException if this pair
     * is bound.
     ...
     * @throws NotInitLObjectException if this logical collection is not bound.
     */
