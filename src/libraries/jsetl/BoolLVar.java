...
public class BoolLVar extends LVar {
    ...
    label(@NotNull LabelingOptions labelingOptions, @NotNull List<BoolLVar> list) {
        ...
        return new Constraint(Environment.labelCode, list, labelingOptions);
    }
    ...
    eq(@NotNull BoolLVar other) {
        ...
        Constraint result =  boolConstraint(other, Environment.eqCode);
        assert result != null;
        return result;
    }
    ...
    eq(@NotNull Boolean bool) {
        ...
        Constraint result =  boolConstraint(bool, Environment.eqCode);
        assert result != null;
        return result;
    }
    ...
    neq(@NotNull BoolLVar other) {
        ...
        Constraint result = boolConstraint(other, Environment.neqCode);
        assert result != null;
        return result;
    }
    ...
    neq(@NotNull Boolean bool) {
        ...
        Constraint result = boolConstraint(bool, Environment.neqCode);
        assert result != null;
        return result;
    }
    ...
    label(@NotNull BoolHeuristic boolHeuristic) {
        ...
        Constraint result = label(labelingOptions);
        assert result != null;
        return result;
    }
