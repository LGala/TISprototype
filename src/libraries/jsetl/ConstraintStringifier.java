 ...
 * in {@code libraries.z.jsetl.configuration.constraintPatterns} are used.
 * @author Andrea Fois
 */
class ConstraintStringifier {
     ...
     * {@code libraries.z.jsetl.configuration.constraintPatterns}.
     */
    public static final ResourceBundle constraintPatterns = ResourceBundle.getBundle("libraries.z.jsetl.configuration.constraintPatterns");
