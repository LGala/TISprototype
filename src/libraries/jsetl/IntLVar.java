...
import libraries.jsetl.exception.NotValidDomainException;
...
public class IntLVar extends LVar implements Visitable {
    ...
    label(@NotNull List<IntLVar> list) {
        ...
        Constraint result = label(new LabelingOptions(), list);
        assert result != null;
        return result;
    }
    ...
    label(@NotNull LabelingOptions labelingOptions, @NotNull List<IntLVar> list) {
        ...
        return new Constraint(Environment.labelCode, arrayList, labelingOptions);
    }
    ...
    label(@NotNull IntLVar... intLVars) {
        ...
        Constraint result = label(labelingOptions, intLVars);
        assert result != null;
        return result;
    }
    ...
    label(@NotNull LabelingOptions labelingOptions, @NotNull IntLVar... intLVars) {
        Constraint result = label(labelingOptions, Arrays.asList(intLVars));
        assert result != null;
        return result;
    }
    ...
    /**
     * Constraint conjunction associated to this variable
     */
     ...
     *      "variable_name = variable_value -- Constraint: constraint" if the variable is bound to a value.
     *      If the domain has no restrictions the output will be
     *      "variable_name = unknown -- Constraint: constraint".
     *      If the domain has a restriction on the upper bound and the domain is a single interval the output will be
     *      "variable_name = unknown, variable_name =< upper_bound -- Constraint: constraint".
     *      If the domain has a restriction on the lower bound and the domain is a single interval the output will be
     *      "variable_name = unknown, variable_name >= lower_bound -- Constraint: constraint".
     *      If the domain has restriction on both upper and lower bounds and the domain is a single interval the output will be
     *      "variable_name = unknown, lower_bound =< variable_name =< upper_bound -- Constraint: constraint".
     *      Otherwise the output will be
     *      "variable_name = variable_vale -- Domain: domain -- Constraint: constraint"
     *      The variable_value may be unknown.
     *      Examples:
     *      "_a = unknown, a =< 3 -- Constraint: _a = _x + _N8 AND _N8 = _y - 1"
     *      "_b = unknown, b >= 3 -- Constraint: _b = _x + _N8 AND _N8 = _y - 1"
     *      "_c = unknown, 3 =< _c =< 4 -- Constraint: _c = _x + _N8 AND _N8 = _y - 1"
     *      "_d = unknown -- Constraint: _d = _x + _N8 AND _N8 = _y - 1"
     *      "_e = 3 -- Constraint: _e = _x + _N8 AND _N8 = _y - 1"
     *      "_f = unknown -- Domain: {-10..10, 20..40} -- Constraint: _z = _x + _N8 AND _N8 = _y - 1"
     */
     @Override
     public void 
     output() {
    ...
    /**
     * Constraint of equality between {@code this} and {@code intLVar}.
    ...
    eq(@NotNull IntLVar intLVar) {
        ...
        Constraint result = ArithConstGenExpr(intLVar, Environment.eqCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint of equality between {@code this} and {@code integer}.
    ...
    eq(@NotNull Integer integer) {
        ...
        Constraint result = ArithConstGenObj(integer, Environment.eqCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint of inequality between {@code this} and {@code intLVar}.
    ...
    neq(@NotNull IntLVar intLVar) {
        ...
        Constraint result = ArithConstGenExpr(intLVar, Environment.neqCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint of inequality between {@code this} and {@code integer}.
    ...
    neq(@NotNull Integer integer) {
        ...
        Constraint result = ArithConstGenObj(integer, Environment.neqCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint which is satisfied if and only if {@code this} is less than or equal to {@code intLVar}.
    ...
    le(@NotNull IntLVar intLVar) {
        ...
        Constraint result = ArithConstGenExpr(intLVar, Environment.leCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint which is satisfied if and only if {@code this} is less than or equal to {@code integer}.
    ...
    le(@NotNull Integer integer) {
        ...
        Constraint result = ArithConstGenObj(integer, Environment.leCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint which is satisfied if and only if {@code this} is less than {@code intLVar}.
     * @param intLVar second argument of the constraint.
    ...
    lt(@NotNull IntLVar intLVar) {
        ...
        Constraint result = ArithConstGenExpr(intLVar, Environment.ltCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint which is satisfied if and only if {@code this} is less than {@code integer}.
     * @param integer second argument of the constraint.
     * @return the generated constraint conjunction (consisting of a single atomic constraint of kind "less than").
     */
    public @NotNull Constraint
    lt(@NotNull Integer integer) {
        ...
        Constraint result = ArithConstGenObj(integer, Environment.ltCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint which is satisfied if and only if {@code this} is greater than or equal to {@code intLVar}.
     * @param intLVar second argument of the constraint.
    ...
    ge(@NotNull IntLVar intLVar) {
        ...
        Constraint result = ArithConstGenExpr(intLVar, Environment.geCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint which is satisfied if and only if {@code this} is greater than or equal to {@code integer}.
     * @param integer second argument of the constraint.
     * @return the generated constraint conjunction (consisting of a single atomic constraint of kind "greater than or equal").
     */
    public @NotNull Constraint
    ge(@NotNull Integer integer) {
        ...
        Constraint result = ArithConstGenObj(integer, Environment.geCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint which is satisfied if and only if {@code this} is greater than {@code intLVar}.
     * @param intLVar second argument of the constraint.
    ...
    gt(@NotNull IntLVar intLVar) {
        ...
        Constraint result = ArithConstGenExpr(intLVar, Environment.gtCode);
        assert result != null;
        return result;
    }

    /**
     * Constraint which is satisfied if and only if {@code this} is greater than {@code integer}.
     * @param integer second argument of the constraint.
     * @return the generated constraint conjunction (consisting of a single atomic constraint of kind "greater than").
     */
    public @NotNull Constraint
    gt(@NotNull Integer integer) {
        ...
        Constraint result = ArithConstGenObj(integer, Environment.gtCode);
        assert result != null;
        return result;
    }
    ...
    in(@NotNull MultiInterval multiInterval) {
        ...
        Constraint result = this.dom(multiInterval);
        return result;
    }
    ...
    nin(@NotNull MultiInterval multiInterval) {
        ...
        Constraint result = this.ndom(multiInterval);
        assert result != null;
        return result;
    }
    ...
    dom(@NotNull Integer glb, @NotNull Integer lub) throws NotValidDomainException{
        ...
        if(multiInterval.isEmpty())
            throw new NotValidDomainException();
        Constraint result = dom(multiInterval);
        assert result != null;
        return result;
    }
    ...
    ndom(@NotNull MultiInterval multiInterval)
        ...
        Constraint result = dom(multiInterval.complement());
        assert result != null;
        return result;
    }
    ...
    public @NotNull Constraint
    label() {
        Constraint result = label(new LabelingOptions());
        assert result != null;
        return result;
    }
