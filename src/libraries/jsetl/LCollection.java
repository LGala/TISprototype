...
import libraries.jsetl.exception.NotInitLObjectException;
...
public abstract class LCollection extends LObject implements Cloneable, Iterable<Object> {
     ...
     */
    public @NotNull Constraint forallElems(@NotNull LVar y, @NotNull Constraint constraint)
        ...
        for(Object object : this){
            Constraint constraintInstance = new ConstraintMapper(y, object).mapConstraintDeeply(constraint);
    ...
    */
     ...
     */
    protected @NotNull Constraint eq(@NotNull LCollection lCollection) {
        assert lCollection != null;

        return new Constraint(Environment.eqCode, this, lCollection);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    protected @NotNull Constraint eq(@NotNull Collection<?> collection) {
        assert collection != null;
        return new Constraint(Environment.eqCode, this, collection);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    protected @NotNull Constraint neq(@NotNull LCollection lCollection) {
        assert lCollection != null;

        return new Constraint(Environment.neqCode, this, lCollection);
    }
     ...
     * @return the constructed constraint conjunction.
     */
    protected @NotNull Constraint neq(@NotNull Collection<?> collection) {
        assert collection != null;

        return new Constraint(Environment.neqCode, this, collection);
    }
