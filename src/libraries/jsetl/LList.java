...
public class LList extends LCollection 
     ...
     */
    public @NotNull Constraint eq(@NotNull LList lList){
        Objects.requireNonNull(lList);

        return new Constraint("_eq", this, lList);
    }
     ...
     * @throws NullPointerException if {@code list} contains {@code null} values.
     */
    public @NotNull Constraint eq(@NotNull List<?> list){
        Objects.requireNonNull(list);
        if(list.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint("_eq", this, list);
    }
     ...
     * @return the constructed constraint.
     */
    public @NotNull Constraint neq(@NotNull LList lList){
        Objects.requireNonNull(lList);

        return new Constraint("_neq", this, lList);
    }
     ...
     * @throws NullPointerException if {@code list} contains {@code null} values.
     */
    public @NotNull Constraint neq(@NotNull List<?> list){
        Objects.requireNonNull(list);
        if(list.stream().anyMatch(Objects::isNull))
            throw new NullPointerException("NULL VALUES NOT ALLOWED");

        return new Constraint("_neq", this, list);
    }
