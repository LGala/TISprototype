...
public class SetLVar extends LVar 
    ...
    label(@NotNull List<SetLVar> setLVars) {
        ...
        return new Constraint(Environment.labelCode, new ArrayList<>(setLVars),
                new LabelingOptions());
    }
    ...
    label(@NotNull LabelingOptions labelingOptions, @NotNull List<SetLVar> setLVars) {
        ...
        return new Constraint(Environment.labelCode, new ArrayList<>(setLVars), labelingOptions);
    }
    ...
    label(@NotNull SetLVar... setLVars) {
        ...
        Constraint result = label(labelingOptions, setLVars);
        assert result != null;
        return result;
    }
    ...
    label(@NotNull LabelingOptions labelingOptions, @NotNull SetLVar... setLVars) {
        ...
        Constraint result = label(labelingOptions, Arrays.asList(setLVars));
        assert result != null;
        return result;
    }
    ...
    public @NotNull Constraint getConstraint(){
        Constraint result = this.constraint.and(this.card.getConstraint());
        assert result != null;
        return result;
    }
    ...
    dom(@NotNull MultiInterval glb, @NotNull MultiInterval lub) {
        ...
        Constraint result = dom(new SetInterval(glb, lub));
        assert result != null;
        return result;
    }
    ...
    dom(@NotNull SetInterval domain) {
        ...
        Constraint result = genCons(Environment.domCode, domain);
        assert result != null;
        return result;
    }
    ...
    eq(@NotNull SetLVar setLVar) {
        ...
        Constraint result = genCons(Environment.eqCode, setLVar);
        assert result != null;
        return result;
    }
    ...
    eq(@NotNull MultiInterval multiInterval) {
        ...
        Constraint result = genCons(Environment.eqCode, multiInterval);
        assert result != null;
        return result;
    }
    ...
    neq(@NotNull SetLVar setLVar) {
        Objects.requireNonNull(setLVar);
        Constraint result = genCons(Environment.neqCode, setLVar);
        assert result != null;
        return result;
    }
    ...
    neq(@NotNull MultiInterval multiInterval) {
        Objects.requireNonNull(multiInterval);
        Constraint result = genCons(Environment.neqCode, multiInterval);
        assert result != null;
        return result;
    }
    ...
    disj(@NotNull SetLVar setLVar) {
        ...
        Constraint result = genCons(Environment.disjCode, setLVar);
        assert result != null;
        return result;
    }
    ...
    disj(@NotNull MultiInterval multiInterval) {
        Objects.requireNonNull(multiInterval);
        Constraint result = genCons(Environment.disjCode, multiInterval);
        assert result != null;
        return result;
    }
    ...
    strictSubset(@NotNull SetLVar setLVar) {
        ...
        Constraint result = genCons(Environment.subsetCode, setLVar);
        assert result != null;
        return result;
    }
    ...
    strictSubset(@NotNull MultiInterval multiInterval) {
        ...
        Constraint result = genCons(Environment.subsetCode, multiInterval);
        assert result != null;
        return result;
    }
    ...
    eq(@NotNull IntLVar element, @NotNull SetLVar rest) {
        ...
        Constraint constraint = tmp.eq(element);
    ...
    eq(@NotNull Collection<IntLVar> elements, @NotNull SetLVar rest) {
        ...
        SetLVar tmp = new SetLVar();
        Constraint constraint = tmp.eq(elements);
    ...
    public @NotNull Constraint
    label() {
        Constraint result = genCons(Environment.labelCode, new LabelingOptions());
        assert result != null;
        return result;
    }
    ...
    label(@NotNull LabelingOptions labelingOptions) {
        Objects.requireNonNull(labelingOptions);
        Constraint result = genCons(Environment.labelCode, labelingOptions);
        assert result != null;
        return result;
    }
    ...
    intersSize(@NotNull SetLVar x, @NotNull SetLVar y) {
        ...
        LinkedList<Interval> listX =
                x.card.getDomain().getIntervals();
        LinkedList<Interval> listY =
